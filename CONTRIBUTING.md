...
Welcome to the contributor guide of PyTestDornech.
...
If you experience bugs or general issues with PyTestDornech, please have a look
...
You can help improve the documentation of PyTestDornech by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/pytestdornech.git
   cd pytestdornech
   ```
